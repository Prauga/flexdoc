...
`prauga-flexdoc-axum` is pinned to `0.5.2` and resolves directly from the published crate on crates.io. Repository CI also patches crates.io resolution to `../../adapters/rust` when validating source changes against the local adapter.
