...
The example is pinned to published `github.com/prauga/flexdoc/adapters/go v0.6.0` and resolves through the public Go module infrastructure. Repository CI may substitute the adapter from `../../adapters/go` when validating local source changes.
