...
`prauga-flexdoc` is pinned to `0.8.1`, the Python package published for FlexDoc 3.3. Repository CI installs the wheel built from the current commit when validating source changes.
