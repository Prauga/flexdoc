...
`prauga-flexdoc` is pinned to `0.6.1` and installs directly from the published PyPI package. Repository CI also installs the wheel built from the current commit when validating source changes.
