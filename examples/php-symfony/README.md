...
Install `prauga/flexdoc` `0.5.0`, register a `FlexDocHost` service, and inject it into `Prauga\FlexDoc\Symfony\FlexDocController`. Map three routes for the documentation shell and renderer assets.
