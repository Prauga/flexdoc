...
The starter is pinned through `<flexdoc.version>0.8.3</flexdoc.version>`, the Java family release published for FlexDoc 3.3. CI installs the Java adapter family built from the same commit before building this example.
