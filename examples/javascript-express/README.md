...
The FlexDoc dependency remains pinned to `2.9.9`, the last published release, during 3.0 release preparation. Repository CI replaces it with the backend package built from the current commit; the post-publish lock-refresh change will advance the registry pin.
