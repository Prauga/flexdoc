...
The FlexDoc dependency is pinned to `2.9.0` and resolves directly from the published npm package. Repository CI also installs the backend package built from the current commit and boots `/docs` to verify source compatibility.
