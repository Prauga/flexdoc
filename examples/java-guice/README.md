...
The FlexDoc JVM host is pinned through `<flexdoc.version>0.8.3</flexdoc.version>`, the Java family release published for FlexDoc 3.3. No Spring Boot or Jakarta REST dependency is required.
