...
export const ApiClient: React.FC<ApiClientProps> = ({
  ...
  >
    <div className='flex flex-col gap-4'>
      ...
      {(hostNotice || hostExecution?.available) && <FlexDocHostNotice message={hostNotice || 'FlexDoc API host is available.'} capabilities={hostExecution?.capabilities} warning={!available && !bodyHost} theme={theme} label={messages?.hostExecutionStatus || 'Host execution status'} />}
