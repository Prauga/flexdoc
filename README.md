...
| NuGet | `Prauga.FlexDoc.AspNetCore` | `0.5.4` |
| Maven | `com.prauga.flexdoc:flexdoc-jvm` | `0.8.4` |
| Maven | `com.prauga.flexdoc:flexdoc-jaxrs` | `0.8.4` |
| Maven | `com.prauga.flexdoc:flexdoc-spring-boot-starter` | `0.8.4` |
